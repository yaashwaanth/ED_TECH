...
const Bar = ({title,value,profit}) =>(
  ...
  >
   ...
   <Progress w="full" value={profit?value:0} coloreScheme="purple" />
...
const Databox=({title,qty,qtyPercentage,profit})=>(
  <Box w={['full',"20%"]} boxShadow={'-2px 0 10px rgba(107,70,193,0.5)'} p="8"
  borderRadius={'lg'}
  ...
  minH={"100vh"} templateColumns={["1fr","5fr 1fr"]}>
   ...
   >
    ...
    justifyContent = {'space-evenly'}>
      ...
      <Databox title="Subscription" qty={13} qtyPercentage={30} profit={true} />
...
<Grid templateColumns={["1fr","2fr 1fr"]}>
  ...
  <Box p="4">
    ...
    <Box>
      <Bar profit={false} title="Views" value={30}/>
