...
const PaymentSuccess = () => {
  ...
  p="16"
  >
   <Heading my="8" textAlign={'center'} children={'You have a Pro Pack'}/>
  ...
  <Box p="4">
    <VStack textAlign={"center"} px='8' mt='4' spacing={'8'}>
      <Text>Congratulations you are a pro member. You have access to premium content.</Text>
